...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_iomodifier_opt_list = 18,       /* iomodifier_opt_list  */
  YYSYMBOL_commands_list = 19,             /* commands_list  */
...
{
       0,    39,    39,    43,    44,    47,    51,    55,    56,    60,
      61,    64,    65,    69,    76,    77,    81,    88,   100,   106,
     113,   120,   126,   131,   136
};
#endif
...
static const char *const yytname[] =
{
  ...
  "GREAT", "NEWLINE", "GREATGREAT", "LESS", "PIPE", "AMPERSAND",
  "GREATGREATAMPERSAND", "EXIT", "$accept", "goal", "commands", "command",
  "simple_command", "iomodifier_opt_list", "commands_list",
...
{
       8,    -2,    -6,    -6,    12,     7,    -6,    -6,     6,    -6,
      -6,    -6,    -6,    -6,    13,    -5,    14,    -6,    15,    -6,
      16,    17,    -6,    18,    -6,    -6,    -6,    19,    -6,    20,
      -6,    21,    23,    -6,    -6
};
...
{
       0,     0,    17,     7,     0,     0,     3,     5,    10,    12,
      15,     8,     1,     4,     0,     0,    13,    11,     0,     6,
       0,     0,    23,     0,     9,    16,    14,    21,    18,    22,
      24,     0,     0,    19,    20
};
...
{
      18,    19,    20,    21,    11,    22,    23,    -2,     1,     1,
       2,     2,    12,     3,     3,    14,     2,    25,    27,    28,
      29,    30,     0,    17,    33,    32,    34,    31,     0,    13
};

static const yytype_int8 yycheck[] =
{
       5,     6,     7,     8,     6,    10,    11,     0,     1,     1,
       3,     3,     0,     6,     6,     9,     3,     3,     3,     3,
       3,     3,    -1,    14,     3,     5,     3,     8,    -1,     5
};
...
{
       0,     1,     3,     6,    14,    15,    16,    17,    19,    20,
      23,     6,     0,    16,     9,    18,    21,    20,     5,     6,
       7,     8,    10,    11,    24,     3,    22,     3,     3,     3,
       3,     8,     5,     3,     3
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 6: /* simple_command: commands_list iomodifier_opt_list NEWLINE  */
#line 51 "shell.y"
                                                 {
...
#line 81 "shell.y"
             {
               printf("   Yacc: insert argument \"%s\"\n", (yyvsp[0].string_val));
				Command::_currentSimpleCommand->expandwildcards((yyvsp[0].string_val));
	}
#line 1209 "y.tab.c"
    break;
...
#line 1223 "y.tab.c"
  ...
  case 18: /* iomodifier_opt: GREATGREAT WORD  */
#line 100 "shell.y"
                       {
...
#line 1233 "y.tab.c"
  ...
  case 19: /* iomodifier_opt: GREAT WORD LESS WORD  */
#line 106 "shell.y"
                            {
		printf("   Yacc: insert output \"%s\"\n", (yyvsp[-2].string_val));
...
#line 1244 "y.tab.c"
  ...
  case 20: /* iomodifier_opt: LESS WORD GREAT WORD  */
#line 113 "shell.y"
                            {
		printf("   Yacc: insert output \"%s\"\n", (yyvsp[0].string_val));
		Command::_currentCommand._outFile = (yyvsp[0].string_val);	
...
#line 1265 "y.tab.c"
  ...
  case 22: /* iomodifier_opt: LESS WORD  */
#line 126 "shell.y"
                  {
		printf("   Yacc: insert input \"%s\"\n", (yyvsp[0].string_val));
		Command::_currentCommand._inputFile = (yyvsp[0].string_val);
...
#line 1274 "y.tab.c"
  ...
  case 23: /* iomodifier_opt: AMPERSAND  */
#line 131 "shell.y"
                 {
...
#line 1283 "y.tab.c"
  ...
  case 24: /* iomodifier_opt: GREATGREATAMPERSAND WORD  */
#line 136 "shell.y"
                                {
		printf("   Yacc: insert output \"%s\"\n", (yyvsp[0].string_val));
